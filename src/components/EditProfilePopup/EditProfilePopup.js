...
function EditProfilePopup({isOpen, onClose, onPopupBackgroundClick, handleUpdateProfile}) {
    ...
    return (
        <PopupWithForm name='profile' title='Edit profile' isOpen={isOpen} onClose={onClose} onPopupBackgroundClick={onPopupBackgroundClick} handleSubmit={handleSubmit}>
            ...
            <div className='popup__field'>
                <input id='profile-about' type='text' name='about' className='popup__input popup__input_type_about' placeholder='About me' required minLength='2' maxLength='200' onChange={handleChange} />
